...
features_file = './features_extraction/saveOUR_multi345200.pkl'
...
for repeat in range(repeat_kfold):
    ...
    train_dataset, test_dataset = train_test_split(features_file, test_size=0.2, random_state=random_seed)
    # Further split the train_dataset into train and validation sets

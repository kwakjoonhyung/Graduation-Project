...
def extract_features(speaker_files, features, params):
    ...
    if not speaker_files:
        print("speaker_files is empty. Please provide valid files.")
        return
    ...
    # Post process
    if not data_tot:
        print("data_tot is empty. Skipping concatenation.")
        return
    ...
    audio_features["seg_mfcc"] = data_mfcc
    audio_features["seg_audio"] = data_audio
    speaker_features = audio_features #(data_tot, labels_tot, labels_segs_tot, segs)
        
    # print("speaker_features dict : ",speaker_features)
    # print("speaker_features : ",len(speaker_features))
    # print("speaker_files : ",len(speaker_files))
    # assert len(speaker_features) == len (speaker_files)
...
if __name__ == '__main__':
    #test
    sig,sr = librosa.load('./test/0001_0001_G1A3E2S0C0_PSB_000001.wav', sr=None)
